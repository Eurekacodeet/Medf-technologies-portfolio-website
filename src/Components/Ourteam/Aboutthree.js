...
const Aboutus = () => {
  const memberData = {
    members: [
      {
        name: 'Kirubel',
        profile:'https://res.cloudinary.com/dvqawl4nw/image/upload/v1681139440/hmgglatf5qjig2tqvjom.png',
        experience: ' Experienced UI/UX Designer, Front-End Developer specializing ineducation, health, ERP, and social media industries. Proven track record of delivering captivating web and mobile products,enhancing user experiences. Skilled in Figma, HTML, CSS, ReactJS, and Flutter. Proficient in GitHub version control.Committed to visually appealing, user-centric designs that drive engagement and business impact.',
        skills: [
          'https://res.cloudinary.com/dvqawl4nw/image/upload/v1684079777/etevadkkl30yftlnctxr.png',
         'https://res.cloudinary.com/dvqawl4nw/image/upload/v1684080844/sjpecmsghfevvv3ffamp.png', 
         'https://res.cloudinary.com/dvqawl4nw/image/upload/v1684081720/ahcxuul8k9rwzmoyincc.png', 
         'ReactJS', 
         'Flutter',
          'GitHub',
        ],
...
{memberData.members.map((member, index) => (
      ...
      <div className="row-span-3 lg:w-2/6 mr-4"><img src={member.profile}/></div>
        ...
        <div className='flex justify-center items-center'>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-1 w-[18vw] h-[18vw] bg-white lg:w-[9vw] lg:h-[9vw] m-auto flex justify-center items-center rounded">
              <p className='text-red-500 text-4xl border-2 boder-blue-500'>{skill}</p>
              {/* <img className="w-full h-full object-contain rounded" src={skill} /> */}
            </div>
            {/* <div className="col-span-1"></div>
            <div className="col-span-1 w-[18vw] h-[18vw]  bg-white lg:w-[9vw] lg:h-[9vw] flex justify-center items-center rounded">
              <img className="w-full h-full object-contain rounded" src="" />
            </div>
            <div className="col-span-1"></div>
            <div className="col-span-1 w-[18vw] h-[18vw]  bg-white lg:w-[9vw] lg:h-[9vw] flex justify-center items-center rounded">
              <img className="w-full h-full object-contain rounded" src="" />
