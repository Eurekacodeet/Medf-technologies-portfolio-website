...
const Aboutus = () => {
  ...
  const certificatesAbuki = [
    {
      ...
      issuerPhoto:
        "https://res.cloudinary.com/dvqawl4nw/image/upload/v1685602315/kzh6heqmawyk3rauq6bq.jpg",
      credentialURL:
        "https://www.virtualbadge.io/certificate-validator?credential=0c4e83b4-a5cd-4583-a171-06aa6e7eaef6",
    },
    {
      id: 2,
      name: "Exam 480: Programming in HTML5 with JavaScript and CSS3",
      issuerPhoto:
        "https://res.cloudinary.com/dvqawl4nw/image/upload/v1685602621/jjhecmbbaau565fnypog.jpg",
      issuer: "Microsoft",
      credentialURL:
        "https://www.credly.com/badges/474d8a86-b9f9-4da5-aab5-31dc60c1c096/linked_in_profile",
    },
    {
      id: 3,
      name: "JavaScript: Functions",
      issuerPhoto:
        "https://res.cloudinary.com/dvqawl4nw/image/upload/v1685602741/blofhl9qp4rcjcfogf9u.jpg",
      issuer: "LinkedIn",
      credentialURL:
        "https://www.linkedin.com/learning/certificates/1ed34551e9e7f3c444edbcb4f2cb6ff9239cb21014cdb1c8c20d3bd2ac97b4bd?trk=backfilled_certificate",
    },
    {
      id: 4,
      ...
      issuer: "Microsoft",
      credentialURL:
        "https://www.youracclaim.com/badges/22e9b845-4780-468e-aae0-a5742d0c696b?source=linked_in_profile",
    },
    {
      id: 5,
      ...
      issuer: "LinkedIn",
      credentialURL:
        "https://www.linkedin.com/learning/certificates/82ffed8ce2ad541c154bfd61fe0ecf6bf227416a3cc64c1f3ed8ed39a21bd6f8?trk=backfilled_certificate&lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_certifications_details%3B16oPA1LCTIGKoefkoRQtsQ%3D%3D",
    },
    {
      id: 6,
      ...
      issuer: "LinkedIn",
      credentialURL:
        "https://www.linkedin.com/learning/certificates/492ef0e3714b5ed69e0f394d9ee692e2239491ef6a1709cf54485fab091f8f54?trk=backfilled_certificate&lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_certifications_details%3B16oPA1LCTIGKoefkoRQtsQ%3D%3D",
    },
    {
      id: 7,
      ...
      issuer: "LinkedIn",
      credentialURL:
        "https://www.linkedin.com/learning/certificates/b9d901bd486626652ee852f2afef0895f34abd030912d0bedd94fe34fb767a90?trk=backfilled_certificate&lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_certifications_details%3B16oPA1LCTIGKoefkoRQtsQ%3D%3D",
    },
    {
      id: 8,
      ...
      issuer: "LinkedIn",
      credentialURL:
        "https://www.linkedin.com/learning/certificates/2aaeb00eeea06eb4e9cceecbbab56b48543fe4922ee4888a13c8693162e241f8?trk=backfilled_certificate&lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_certifications_details%3B16oPA1LCTIGKoefkoRQtsQ%3D%3D",
    },
    // Add more certificate objects as needed
  ];
  const certificatesAbel = [
    {
      ...
      issuerPhoto:
        "https://res.cloudinary.com/dvqawl4nw/image/upload/v1685602315/kzh6heqmawyk3rauq6bq.jpg",
      credentialURL:
        "https://www.virtualbadge.io/certificate-validator?credential=c40234dc-da11-456f-b588-53fcded6b45a",
    },
    {
      id: 2,
      ...
      issuerPhoto:
        "https://res.cloudinary.com/dvqawl4nw/image/upload/v1685602315/kzh6heqmawyk3rauq6bq.jpg",
      credentialURL:
        "https://asset.cloudinary.com/dr9k0vqob/246d5355f854d39e9f8a958cc1bf27b1",
    },
    {
      id: 3,
      ...
      issuer: "Sophos",
      issuerPhoto:
        "https://res.cloudinary.com/dvqawl4nw/image/upload/v1685701919/mksy3sgp4ijwy7mnxoga.jpg",
      credentialURL:
        "https://asset.cloudinary.com/dr9k0vqob/9bc921cf13d31285d89180e3c6d4278a",
    },
    {
      id: 4,
      ...
      issuerPhoto:
        "https://res.cloudinary.com/dvqawl4nw/image/upload/v1685701919/mksy3sgp4ijwy7mnxoga.jpg",
      credentialURL:
        "https://asset.cloudinary.com/dr9k0vqob/1423fe67d183498e24647c0cdf6059b8",
    },
    // {
    //   id: 2,
    //   name: 'Introduction to Git and GitHub',
  ...
  const visibleCertificatesAbuki = certificatesAbuki.slice(
    0,
    visibleCountAbuki
  );
  ...
  const tabsAboutus = [
    {
      ...
      content: () => (
        <div>
          <div>
            <p className="text-base max-w-md pt-4">Hello, I'm</p>
            ...
            >
              ...
              education, health, ERP, and social media industries. Proven track
              record of delivering captivating web and mobile products,
              enhancing user experiences. Skilled in Figma, HTML, CSS, ReactJS,
              and Flutter. Proficient in GitHub version control. Committed to
              visually appealing, user-centric designs that drive engagement and
              business impact.
            </Paragraph>
        ...
        <div>
          <div>
            ...
            <Paragraph
              ...
              // }
            >
              Experienced Mobile App Developer. Passionate about Data Analysis
              and Insights. Expertise in iOS and Android Applications
              Development
            </Paragraph>
          ...
          <div
            ...
            <ResponsiveContainer bounce="100%" width="100%" height="100%">
              <RadarChart
                ...
                cy="50%"
                outerRadius={`${size < 500 ? "60%" : "80%"}`}
                data={size < 500 ? dataSmAbuki : dataAbuki}>
                <PolarGrid />
                <PolarAngleAxis dataKey="subject" />
                <PolarRadiusAxis />
                <Radar
        ...
        <div>
          <div>
            ...
            <Paragraph
              ...
              // }
            >
              As an experienced software developer, I have a proven track record
              of designing, developing, and delivering high-quality software
              applications. My expertise in a range of programming languages and
              technologies, combined with my strong problem-solving skills,
              attention to detail, and ability to work collaboratively, makes me
              an asset to any software development team. Throughout my career, I
              have demonstrated the ability to work in dynamic environments,
              adapting quickly to changing priorities and deadlines. Whether
              working independently or as part of a team, I am dedicated to
              delivering exceptional results that meet both technical and
          ...
          <div
            ...
            <ResponsiveContainer bounce="100%" width="100%" height="100%">
              <RadarChart
                ...
                cy="50%"
                outerRadius={`${size < 500 ? "60%" : "80%"}`}
                data={size < 500 ? dataSmAbel : dataAbel}>
                <PolarGrid />
                <PolarAngleAxis dataKey="subject" />
                <PolarRadiusAxis />
                <Radar
...
mt-4 hover:w-[16.7rem] transition-width bg-white duration-500 ease-in-out shadow shadow-white"></div>
        ...
        <div className="flex flex-col lg:flex-row justify-evenly borer-4 borer-purple-900 bg-white mt-10 p-10 rounded">
          <div className="">
            <img
              className="lg:w-full w-full brder boder-yellow-500 sm:w-full"
              src="https://res.cloudinary.com/dvqawl4nw/image/upload/v1685455757/s5dec8kw6e0982jsywcv.png"
            />
          </div>
...
<div><h1 onClick={handleCertification} className={`text-base select-none hover:cursor-pointer ${contentState=="Certifications"?"font-bold underline underline-offset-4":"font-normal"} pr-6`}>Certifications  </h1></div> */}
        ...
        <div className="flex flex-col lg:flex-row justify-evenly bordr-4 brder-purple-900 bg-white mt-10 p-10 rounded">
          <div className="">
            <img
              className="lg:w-full w-full brder boder-yellow-500 sm:w-full"
              src="https://res.cloudinary.com/dvqawl4nw/image/upload/v1685464201/ry2mkj5e0pg7bnttq7yu.png"
            />
          </div>
          <div className="flex lg:w-[80vw] sm:w-[100vw] w-[80vw] flex-col brder brder-500">
            <div className="flex flex-row">
...
<div><h1 onClick={handleCertification} className={`text-base select-none hover:cursor-pointer ${contentState=="Certifications"?"font-bold underline underline-offset-4":"font-normal"} pr-6`}>Certifications  </h1></div> */}
        ...
        <div className="flex flex-col lg:flex-row justify-evenly bordr-4 brder-purple-900 bg-white mt-10 p-10 rounded">
          <div className="">
            <img
              className="lg:w-full w-full brder boder-yellow-500 sm:w-full"
              src="https://res.cloudinary.com/dvqawl4nw/image/upload/v1685455756/dpm5rxwymxxzjka7rwcv.png"
            />
          </div>
          <div className="flex lg:w-[80vw] sm:w-[100vw] w-[80vw] flex-col brder brder-500">
            <div className="flex flex-row">
