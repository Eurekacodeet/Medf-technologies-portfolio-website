...
const ContactUs = () => {
  ...
  return (
    <div className="flex flex-col items-center h-full p-10 bg-white mt-100">
      <div className="group">
        <h1 className="text-[1.6rem] font-bold break-words text-black whitespace-pre">
          C o n t a c t u s{" "}
        </h1>
          ...
          <div className="md:w-1/2 mt-4 md:mt-0 md:border-l-[1px] md:border-l-400 bg-fill bg-black h-full pl-2 pr-2 md:pl-10 md:pr-4 md:py-10 ">
            <Form
              ...
              <Form.Item
                name="service"
                label={
                  <label style={{ color: "white" }}>Type of Service</label>
                }
                rules={[
                  {
                    required: true,
                ...
                <Select
                  ...
                  <Option value="computer-installation-maintenance">
