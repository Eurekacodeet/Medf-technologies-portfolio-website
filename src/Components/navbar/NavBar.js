        ...
        <nav id="nav" className="bg-black dark:bg-black sticky w-full z-20 top-0 left-0 border-b border-black dark:border-black">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex md:order-2">
                    <Link to="/contact" className="flex items-center text-white bg-black hover:bg-white hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-800 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0">
                        Contact Us
                    </Link>
   ...
   <Menu  mode="horizontal"
        ...
        selectedKeys={[currentMenu]}><Menu.Item key="menu" onClick={handleDrawerShow} as="div"><MenuOutlined className='text-xl'/></Menu.Item>
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium borderrounded-sm md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-black md:dark:bg-black dark:border-black">
                        <li className='group/home hover:cursor-pointer'>
                            <div className='w-fit'>
                            <Link to="/">  <p className="block py-2 pl-3 pr-4 text-white bg-black md:bg-transparent md:p-0 hover:cursor-pointer" aria-current="page">Home </p></Link>
                        ...
                        <button onClick={()=>handleNavbarClick('ourservices')}><p className="block py-2 pl-3 pr-4 text-white bg-black rounded md:bg-transparent md:p-0 hover:cursor-pointer">Services</p></button> 
...
<li className='group/our_team hover:cursor-pointer'>
                           ...
                           <Link to="/ourteam"> <p className="block py-2 pl-3 pr-4 text-white bg-black rounded md:bg-transparent md:p-0">Our Team</p></Link>
...
<li className='group/about hover:cursor-pointer'>
                        ...
                        <button onClick={()=>handleNavbarClick("about")}> <p className="block py-2 pl-3 pr-4 text-white bg-black rounded md:bg-transparent md:p-0 hover:cursor-pointer">About</p></button>
