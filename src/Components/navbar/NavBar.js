                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium borderrounded-sm md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li className='group/home hover:cursor-pointer'>
                            <div className='w-fit'>
                            <Link to="/">  <p class="block py-2 pl-3 pr-4 text-white bg-gray-100 md:bg-transparent md:p-0 hover:cursor-pointer" aria-current="page">Home </p></Link>
                        ...
                        <li className='group/our_team hover:cursor-pointer'>
                           <Link to="/ourteam"> <p class="block py-2 pl-3 pr-4 text-white bg-gray-100 rounded md:bg-transparent md:p-0">Our Team</p></Link>
                            <div className='rounded-full bg-white w-0 h-[0.15rem] mt-1 relative
