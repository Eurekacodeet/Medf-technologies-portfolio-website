...
export default function NavBar() {
  ...
  return (
    <nav
      id="nav"
      className="bg-black dark:bg-back sticky w-full z-20 top-0 left-0 border-b border-black dark:border-gray-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2">
          <Link
            to="/contact"
            className="flex items-center text-white bg-gray-700 hover:bg-white hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-800 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0">
            Contact Us
          </Link>
          ...
          <div className="md:hidden m-2 h-full hover:cursor-pointer text-3xl">
            <Menu
              ...
              <Menu.Item key="menu" onClick={handleDrawerShow} as="div">
        ...
        <div
          ...
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium borderrounded-sm md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li className="group/home hover:cursor-pointer">
              <div className="w-fit">
                <Link to="/">
                  {" "}
                  <p
                    className="block py-2 pl-3 pr-4 text-white bg-gray-100 md:bg-transparent md:p-0 hover:cursor-pointer"
                    aria-current="page">
                    Home{" "}
                  </p>
                </Link>
            ...
            <li className="group/about hover:cursor-pointer">
              <button onClick={() => handleNavbarClick("about")}>
                {" "}
                <p className="block py-2 pl-3 pr-4 text-white bg-gray-100 rounded md:bg-transparent md:p-0 hover:cursor-pointer">
                  About
                </p>
              </button>
              <div
                className="rounded-full bg-white w-0 h-[0.15rem] mt-1
            ...
            <li className="group/services hover:cursor-pointer">
              <button onClick={() => handleNavbarClick("ourservices")}>
                <p className="block py-2 pl-3 pr-4 text-white bg-gray-100 rounded md:bg-transparent md:p-0 hover:cursor-pointer">
                  Services
                </p>
              </button>
              <div
                className="rounded-full bg-white w-0 h-[0.15rem] mt-1 relative
                            transition-all duration-300 ease-in-out group-hover/services:w-full"></div>
            </li>
            <li className="group/our_team hover:cursor-pointer">
              <Link to="/ourteam">
                {" "}
                <p className="block py-2 pl-3 pr-4 text-white bg-gray-100 rounded md:bg-transparent md:p-0">
                  Our Team
                </p>
              </Link>
              <div
        ...
        <Drawer
          ...
          <Menu
            ...
            <Menu.Item key="home" as="div" onClick={handleDrawerClose}>
              <Link to="/">
                <button onClick={() => setIsDrawerVisible(false)}>Home</button>{" "}
              </Link>
            </Menu.Item>
