...
const Dh = () => {
  ...
  const text =
    "For better performance, switch to the video view by clicking the cube. We're optimizing the 3D view soon. Enjoy the video experience despite any performance issues.";
  return (
    <div className="flex flex-col bg-black text-white p-10 h-[100vh] md:flex md:flex-row overflow-hidden dh-component">
      {showButton ? (
        <button
          onClick={handleScroll}
          className="fixed bottom-10 z-50 right-10 bg-white text-black py-2 px-4 border-[1px] border-black rounded-full">
      ...
      <div className="w-full mr-10 md:w-2/5">
        <Carousel
          autoplay
          className="pb-8 bordr-2 flex flex-row justify-evenly border-blue-500">
          <div className={` ${size >= 768 && "pt-[20vh]"}`}>
            <p className="text-sm text-white">Obtain High Quality Webapps</p>
            <div className="relative group text-white">
              <h1 className="text-3xl py-4 font-bold text-white mb-8 hover:cursor-default">
            ...
            <p className="text-sm text-white">
              We help you to grow your business by developing awesome and
          ...
          <div>
            <div className={` ${size >= 768 ? "pr-4 pt-[20vh]" : "pr-4 "}`}>
              ...
              <p className="text-sm text-white">
                We specialize in creating cutting-edge mobile applications that
                provide seamless user experiences and drive business growth.
              </p>
              <Link to="/contact" className="">
                <button className="bg-white mt-4 text-black hover:font-bold hover:bg-white hover:text-black rounded-full px-4 py-2">
                  <p className="text-sm">Contact Us</p>
          ...
          <div className="">
            <div className={` ${size >= 768 ? "pr-4 pt-[20vh]" : "pr-4 "}`}>
              ...
              <p className="text-sm text-white">
                We offer professional graphics design services to bring your
                ideas to life with captivating visuals and engaging designs.
              </p>
              <Link to="/contact" className="">
                <button className="bg-white mt-4 text-black hover:font-bold hover:bg-white hover:text-black rounded-full px-4 py-2">
                  <p className="text-sm">Contact Us</p>
          ...
          <div>
            <div className={` ${size >= 768 ? "pr-4 pt-[20vh]" : "pr-4 "}`}>
              ...
              <p className="text-sm text-white">
                Our expert animators use Blender & other animation softwares to
                create immersive 3D animations that capture attention and tell
      ...
      <div className="md:w-3/5 h-[100%] w-full md:h-full pt-2">
        <button
          ...
          onClick={toggleConditionalMode}>
          {!conditionalMode ? (
            <div className="mt-4 flex flex-row items-center justify-center">
              <CubeIcon
                className="bg-white text-black rounded mr-4"
                width={32}
              />
              ...
              <p className="text-xs">
                Experiencing performance issues click the cube
              </p>
            </div>
          ) : (
            <div className="mt-4 flex flex-row items-center justify-center">
              ...
              <p className="text-xs">
                Click the video icon to see something cool
              </p>
            </div>
          )}
        </button>
        {!conditionalMode ? (
          <div className="md:w-full h-[87%] w-full md:h-[90%] pt-2">
            <Canvas className="">
              <OrbitControls />
          ...
          <div className="md:w-full h-[80%] w-full md:h-[80%] pt-2">
            <video
